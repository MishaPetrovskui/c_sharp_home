...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine(firstCard < secondCard);
        Console.WriteLine(firstCard > secondCard);
        Console.WriteLine(firstCard.Equals(secondCard));
        CreditCard card3 = firstCard;
        Console.WriteLine(firstCard.Equals(card3));
    }
}
...
namespace Game
{
    class CreditCard
    {
        ...
        public static CreditCard operator +(CreditCard a, int value) { a.Balance += value; return a; }
        public static CreditCard operator -(CreditCard a, int value) { a.Balance -= value; return a; }
        public static bool operator ==(CreditCard a, CreditCard b) { return (a.CVV == b.CVV); }
        public static bool operator !=(CreditCard a, CreditCard b) { return !(a.CVV == b.CVV); }
        public static bool operator <(CreditCard a, CreditCard b) { return (a.Balance < b.Balance); }
        public static bool operator >(CreditCard a, CreditCard b) { return (a.Balance > b.Balance); }
        public override bool Equals(object obj)
        {
            ...
            CreditCard othetCard = (CreditCard)obj;
            return this.CVV == othetCard.CVV && this.Balance == othetCard.Balance;
        }
        public override string ToString()
        {
            return $"{this.SNM}: {this.CardNumber}, Expiry: {this.Month}/{this.Year}, Balance: {this.Balance} uah";
        }
        public override int GetHashCode()
        {
            return (this.CVV + this.Balance.ToString()).GetHashCode();
        }
    }
}
